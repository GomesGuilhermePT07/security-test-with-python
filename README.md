...
<p>
  ...
  This project is distributed under the **MIT License**. Check [LICENSE](https://github.com/dev-ggomes/security-test-with-python?tab=MIT-1-ov-file) for full terms.
